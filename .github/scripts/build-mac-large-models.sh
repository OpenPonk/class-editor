...
First option requires a little more clicking each time opening OpenPonk, but simpler first time setup.
...
zip -qr $PROJECT_NAME-$PLATFORM-$VERSION-large-models.zip $package_dir
